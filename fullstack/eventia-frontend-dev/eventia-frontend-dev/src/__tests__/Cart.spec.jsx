...
describe('Cart Component', () => {
  ...
  it('debe llamar a la funcion onRemoveFromCart con el id correcto', () => {
  ...
  // eliminacion de elementos del carrito
  it('llama a la funcion de remover cuando se hace click en el boton eliminar', () => {
  ...
  // ejecucion del checkout
  it('llama a la funcion onCheckout cuando se hace click en finalizar compra', () => {
  ...
  // calculo total con multiples productos
  ...
  it('muestra alerta de carrito vacio cuando no hay productos', () => {
    act(() => {
      createRoot(container).render(
        <Cart
          cartItems={[]}
